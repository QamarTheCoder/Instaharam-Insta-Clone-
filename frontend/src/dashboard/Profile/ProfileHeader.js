    ...
    return(
        <div className="d-flex "> 
            ...
            <div className="d-flex flex-column ">
                ...
                { ownprofile ? 
                 <button style={{border:'none', backgroundColor:"rgb(235, 235, 235)" , color:'black', padding:'3px 10px', borderRadius:'8px', width:'90px', height:'30px', fontWeight:'400'}}>Settings</button>
                 : 
